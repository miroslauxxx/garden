...
## **INSTRUCTIONS**
  ...
  ### **Standards and Rules**
    ...
    - The Norm: Code must strictly comply with the Norm; any norm error will result in a grade of 0.  
...
Detailed description and docs related to library https://garden.miroslau.workers.dev/